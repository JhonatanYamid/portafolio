...
const Footer = () => {
    return (
        ...
        <footer className="bg-gray-900 flex item-center justify-center space-x-20 p-8 text-slate-300">
            <div className="flex flex-col space-y-4 w-2/5">
                <h4 className="font-bold text-2xl">Cotizar un desarrollo</h4>
                ...
                <div className='flex justify-left pt-2'>
                    <a className="rounded px-5 btn-primary text-md">
                        Contacto &gt;
                    </a>
                </div>
            </div>
            <div className="flex flex-col space-y-5 w-2/5 items-center justify-center">
                <h4 className="font-bold text-2xl">Redes Sociales</h4>
                <div className="flex flex-row space-x-5">
                    <a href="https://www.facebook.com/jhonatan.yamid.7" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://www.instagram.com/jhonatan_yamid/" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://www.linkedin.com/in/jhonatan-yamid-a8a8b818b/" target="_blank" rel="noopener noreferrer">
